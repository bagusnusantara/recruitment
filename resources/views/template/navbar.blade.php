    ...
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            ...
            <li class="@if(url('admin/klien') == request()->url()
                    ...
                    <a href="{{ url('admin/klien')}}"><i class="fa fa-handshake"></i> <span class="nav-label">Master Data Site</span></a>
            </li>

            <li class="@if(url('admin/lowongan') == request()->url()
               ) active @else '' @endif  treeview">
                    <a href="{{ url('admin/lowongan')}}"><i class="fa fa-newspaper"></i> <span class="nav-label">Lowongan Pekerjaan</span></a></li>
            ...
            or url('/hrd/sdm/resign') == request()->url()) active @else '' @endif treeview">
				...
				<ul class="nav nav-second-level collapse">
                    <li class="@if(url('hrd/sdm/smi') == request()->url()) active @else '' @endif"><a href="{{ url('/hrd/sdm/smi') }}">Data Pegawai Aktif</a></li>
                    <li class="@if(url('hrd/sdm/smi') == request()->url()) active @else '' @endif"><a href="#">Data Pegawai Resign</a></li>
