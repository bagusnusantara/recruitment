...
<!--                             <div class="m-b-sm"><center>
                            ...
                            <br><div class="text-center"><a type="button" class="btn btn-primary " href="{{url()->current()}}/pdf" type="button"><i class="fa fa-print"> Download PDF</i></a></div>
                            @endforeach
                        </dl>
                    </div>
                    <div class="col-lg-7" id="cluster_info">
                        <dl class="dl-horizontal" >
                            @foreach($pelamar as $p)
                            @php
                                $storage_path = storage_path('app/jobseeker/foto_pelamar/'.$p->lampiran_foto);
                            @endphp
                                <img src="{{$storage_path}}" width="160px" height="240px">
                            @endforeach
                        </dl>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <h3 class="text-center" style="color: #000000">PENDIDIKAN FORMAL</h3>
                    </div>
                ...
                <div class="row">
                    <div style="background-color: #e7e7e7; padding: 2px">
                    <h3 class="text-center" style="color: #000000">PENDIDIKAN NON FORMAL</h3>
                    </div>
                    <table class="table table-bordered">
                        <thead>
                        <tr>
                ...
                <div class="row">
                    <div style="background-color: #e7e7e7; padding: 2px">
                    <h3 class="text-center" style="color: #000000">PENDIDIKAN BAHASA</h3>
                    </div>
                    <table class="table table-bordered">
                        <thead>
                        <tr>
                ...
                <div class="row">
                    <div style="background-color: #e7e7e7; padding: 2px">
                    <h3 class="text-center" style="color: #000000">RIWAYAT PEKERJAAN</h3>
                    </div>
                    <table class="table table-bordered">
                        <thead>
                        <tr>
                ...
                <div class="row">
                    <div style="background-color: #e7e7e7; padding: 2px">
                    <h3 class="text-center" style="color: #000000">MINAT PEKERJAAN</h3>
                    </div>
                    <table class="table table-bordered">
                        <thead>
                        <tr>
                ...
                <div class="row">
                    <div style="background-color: #e7e7e7; padding: 2px">
                    <h3 class="text-center" style="color: #000000">PENGALAMAN ORGANISASI</h3>
                    </div>
                    <table class="table table-bordered">
                        <thead>
                        <tr>
                ...
                <div class="row">
                    <div style="background-color: #e7e7e7; padding: 2px">
                    <h3 class="text-center" style="color: #000000">RIWAYAT PENYAKIT</h3>
                    </div>
                    <table class="table table-bordered">
                        <thead>
                        <tr>
