                              ...
                              <div class="modal-dialog modal-lg">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                      <form method="POST" action="{{url('/hrd/setup/bpjs/store')}}" class="form-horizontal" enctype="multipart/form-data">
                                            @csrf
                                            @include('hrd.setup.bpjs.form')
                                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-client" style="width: 100%">
                            ...
                            <tbody>
                              @php
    								$i=1;
    							@endphp
                              @foreach($st_pot_bpjs as $u)

                              <tr>
                                  <td class="text-center">{{$i}}</td>
                                  <td>{{$u->kode_bpjs}}</td>
                                  <td>{{$u->deskripsi}}</td>
                                  <td>{{$u->prosen_potongan}}</td>
                                  <td>{{$u->prosen_pend_pph}}</td>
                                  <td>{{$u->id_jht}}</td>
                                  <td>{{$u->id_jkk}}</td>
                                  <td>{{$u->id_jkm}}</td>
                                  <td>{{$u->id_jp}}</td>
                                  <td>{{$u->id_bpjs_kes}}</td>
                                  <td>{{$u->id_jht_prshn}}</td>
                                  <td>{{$u->id_jkk_prshn}}</td>
                                  <td>{{$u->id_jkm_prshn}}</td>
                                  <td>{{$u->id_jp_prshn}}</td>
                                  <td>{{$u->id_bpjs_kes_prshn}}</td>

                                  <td class="text-center">
                                    <button class="btn btn-default btn-circle"
                                          data-kodebpjs="{{$u->kode_bpjs}}"
                                          data-deskripsi="{{$u->deskripsi}}"
                                          data-prosenpotongan="{{$u->prosen_potongan}}"
                                          data-prosenpendpph="{{$u->prosen_pend_pph}}"
                                          data-idjht="{{$u->id_jht}}"
                                          data-idjkk="{{$u->id_jkk}}"
                                          data-idjkm="{{$u->id_jkm}}"
                                          data-idjp="{{$u->id_jp}}"
                                          data-idbpjskes="{{$u->id_bpjs_kes}}"
                                          data-idjhtprshn="{{$u->id_jht_prshn}}"
                                          data-idjkkprshn="{{$u->id_jkk_prshn}}"
                                          data-idjkmprshn="{{$u->id_jkm_prshn}}"
                                          data-idjpprshn="{{$u->id_jp_prshn}}"
                                          data-idbpjskesprshn="{{$u->id_bpjs_kes_prshn}}"
...
<div class="modal inmodal fade" id="delete" tabindex="-1" role="dialog"  aria-hidden="true">
      <div class="modal-dialog modal-lg">
          <div class="modal-content">
              ...
              <div class="modal-body">
              <form method="POST" action="{{ url('/hrd/setup/bpjs/delete/{id}') }}" class="form-horizontal" enctype="multipart/form-data">
                @csrf
                @method('DELETE')
...
<div class="modal inmodal fade" id="edit" tabindex="-1" role="dialog"  aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                <form method="POST" action="{{ url('/hrd/setup/bpjs/update/{id}') }}" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="hkode_bpjs" id="hkode_bpjs" value="" />
                        <div class="form-group"><label class="col-sm-4 control-label">Kode Bpjs</label>
                            <div class="col-sm-8"><input type="text" class="form-control" name="kode_bpjs" id="kode_bpjs" disabled></div>
