                              ...
                              <div class="modal-dialog modal-lg">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                      <form method="POST" action="<?php echo e(url('/hrd/setup/tunjanganjabatan/store')); ?>" class="form-horizontal" enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                            <?php echo $__env->make('hrd.setup.tunjanganjabatan.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-client" style="width: 100%">
                            ...
                            <tbody>
                              <?php
                				$i=1;
                				?>
                              <?php $__currentLoopData = $st_tunj_jabatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                              <tr>
                                  <td class="text-center"><?php echo e($i); ?></td>
                                  <td class="text-center"><?php echo e($u->Deskripsi); ?></td>
                                  <td class="text-center"><?php echo e($u->nama_client); ?></td>
                                  <td><center><?php echo e($u->tunj_jabatan); ?></center></td>
                                  <td><center><?php echo e($u->tgl_berlaku); ?></center></td>
                                  <td class="text-center">
                                    <button class="btn btn-default btn-circle"
                                          data-kodejabatan="<?php echo e($u->kode_jabatan); ?>"
                                          data-kodesite="<?php echo e($u->kode_site); ?>"
                                          data-tunjanganjabatan="<?php echo e($u->tunj_jabatan); ?>"
                                          data-tanggalberlaku="<?php echo e($u->tgl_berlaku); ?>"
                                          data-toggle="modal" data-target="#show"><i class="fa fa-eye"></i>
                                    </button>
                                    <a href="<?php echo e(url('/hrd/setup/tunjanganjabatan/edit/'.$u->kode_jabatan.'/'.$u->kode_site.'' )); ?>">
                                        <button class="btn btn-default btn-circle"
                                            data-kodejabatan="<?php echo e($u->kode_jabatan); ?>"
                                            data-kodesite="<?php echo e($u->kode_site); ?>"
                                            data-tunjanganjabatan="<?php echo e($u->tunj_jabatan); ?>"
                                            data-tanggalberlaku="<?php echo e($u->tgl_berlaku); ?>"><i class="fa fa-pencil-square-o"></i>
                                        </button>
                                    </a>
                                    <button class="btn btn-default btn-circle"                                         
                                          data-id ="<?php echo e($u->kode_jabatan); ?>"
                                          data-kodejabatan="<?php echo e($u->kode_jabatan); ?>"
                                          data-kodesite="<?php echo e($u->kode_site); ?>"
                                          data-tunjanganjabatan="<?php echo e($u->tunj_jabatan); ?>"
                                          data-tanggalberlaku="<?php echo e($u->tgl_berlaku); ?>"
...
<div class="modal inmodal fade" id="edit" tabindex="-1" role="dialog"  aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                <form method="POST" action="<?php echo e(url('/hrd/setup/tunjanganjabatan/update/{id}')); ?>" class="form-horizontal" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<div class="modal inmodal fade" id="delete" tabindex="-1" role="dialog"  aria-hidden="true">
      <div class="modal-dialog modal-lg">
          <div class="modal-content">
              ...
              <div class="modal-body">
              <form method="POST" action="<?php echo e(url('/hrd/setup/tunjanganjabatan/delete/{id}')); ?>" class="form-horizontal" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('template.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\recruitment\resources\views/hrd/setup/tunjanganjabatan/index.blade.php ENDPATH**/ ?>