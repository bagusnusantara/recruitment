...
<div class="form-group"><label class="col-sm-4 control-label">Pola id</label>
    <div class="col-sm-8"><input type="text" maxlength="5" class="form-control" name="polaid" id="polaid"></div>
</div>
...
</div><?php /**PATH C:\xampp\htdocs\recruitment\resources\views/hrd/setup/schpola/form.blade.php ENDPATH**/ ?>