<div class="modal inmodal fade" id="Modaltambah" tabindex="-1" role="dialog"  aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="POST" action="<?php echo e(url('/pegawai/cuti/store')); ?>" class="form-horizontal" enctype="multipart/form-data">
...
<?php /**PATH C:\xampp\htdocs\recruitment\resources\views/pegawai/cuti/modal_add.blade.php ENDPATH**/ ?>