    ...
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            ...
            <li class="<?php if(url('admin/klien') == request()->url()
                    ...
                    <a href="<?php echo e(url('admin/klien')); ?>"><i class="fa fa-handshake"></i> <span class="nav-label">Master Data Site</span></a>
            </li>

            <li class="<?php if(url('admin/lowongan') == request()->url()
               ): ?> active <?php else: ?> '' <?php endif; ?>  treeview">
                    <a href="<?php echo e(url('admin/lowongan')); ?>"><i class="fa fa-newspaper"></i> <span class="nav-label">Lowongan Pekerjaan</span></a></li>
            ...
            or url('/hrd/sdm/resign') == request()->url()): ?> active <?php else: ?> '' <?php endif; ?> treeview">
				...
				<ul class="nav nav-second-level collapse">
                    <li class="<?php if(url('hrd/sdm/smi') == request()->url()): ?> active <?php else: ?> '' <?php endif; ?>"><a href="<?php echo e(url('/hrd/sdm/smi')); ?>">Data Pegawai Aktif</a></li>
                    <li class="<?php if(url('hrd/sdm/smi') == request()->url()): ?> active <?php else: ?> '' <?php endif; ?>"><a href="#">Data Pegawai Resign</a></li>
