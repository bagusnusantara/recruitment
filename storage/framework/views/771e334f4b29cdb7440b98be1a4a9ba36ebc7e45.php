        ...
        <div class="inner-box">
          ...
          <div class="inner-box">
            <div class="item">
              ...
              <input type="text" class="form-control" id="Olahraga" placeholder="Masukan aktivitas olahraga" value="<?php echo e($dataUser->olahraga); ?>">
                </div>
                <div class="form-group">
                    <h4><label for="Hobi">Hobi</label></h4>
                    <input type="text" class="form-control" id="Hobi" placeholder="Masukan hobi" value="<?php echo e($dataUser->hobi); ?>"> 
                </div>
              ...
              <h4>Organisasi</h4>
                <table id="aktivitas-table" class="table table-bordered" style="border-radius:10px;">
                    ...
                    <?php $__currentLoopData = $dataUserSt['PengalamanOrganisasi']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <th><h4><?php echo e($item->organisasi); ?></h4></th>
                        <th data-tanggalmulai="<?php echo e(date("M-Y",strtotime($item->tanggal_mulai))); ?>" data-tanggalakhir="<?php echo e(date("M-Y",strtotime($item->tanggal_akhir))); ?>"><h4><?php echo e(date("M-Y",strtotime($item->tanggal_mulai))); ?> - <?php echo e(date("M-Y",strtotime($item->tanggal_akhir))); ?></h4></th>
                        <th><h4><?php echo e($item->tempat); ?></h4></th>
                        <th><h4><?php echo e($item->posisi); ?></h4></th>
                        <th><h4><?php echo e($item->keterangan); ?></h4></th>
                        <th width="10%"><h4>
                            <button data-toggle="modal"  data-target=".aktivitas-modal" data-id="<?php echo e($item->id); ?>" class="mx-auto btn-outline-primary rounded"><i class="fa fa-edit fa-1x"></i></button>
                            <button data-toggle="modal"  data-target="#deletemodal"  data-id="<?php echo e($item->id); ?>" data-href="datadiri/deletepengalamanorganisasi/"  class="btn-outline-danger rounded"><i class="fa fa-trash fa-1x"></i></button>
                        </h4></th>
                    </tr>
...
<?php /**PATH C:\xampp\htdocs\recruitment\resources\views/jobseeker/datadiri/aktivitas.blade.php ENDPATH**/ ?>