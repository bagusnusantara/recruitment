<div id="lampiran"  class="tab-content my-resume">
    <div class="inner-box">
        ...
        <div class="inner-box">
            <div class="item">
                ...
                <form id="fotopelamar" enctype="multipart/form-data">
                    <div class="form-group <?php echo e(($dataUser->lampiran_foto)?"hidden-block":""); ?>">
                        <h4>Foto Pelamar</h4>
                      ...
                      <div class="job-listings-featured block-action <?php echo e((!$dataUser->lampiran_foto)?"hidden-block":"isUploaded"); ?>" id="fotopelamar-show">
                        <div class="row">
                          <div class="col-lg-5 col-md-5 col-xs-12">
                            <div class="job-details ml-5 mt-4">
                            <h3 class="title">Foto.<?php echo e(pathinfo($dataUser->lampiran_foto,PATHINFO_EXTENSION)); ?></h3>
                  ...
                  <form id="scanijazah" enctype="multipart/form-data">
                      <div class="form-group <?php echo e(($dataUser->lampiran_ijazah)?"hidden-block":""); ?>">
                          <h4>Scan Ijazah</h4>
                          <div class="input-group">
                            <div class="custom-file">
                        ...
                        <div class="job-listings-featured block-action <?php echo e((!$dataUser->lampiran_ijazah)?"hidden-block":"isUploaded"); ?>" id="ijazah-show">
                          <div class="row">
                            <div class="col-lg-5 col-md-5 col-xs-12">
                              <div class="job-details ml-5 mt-4">
                                <h3 class="title">ScanIjazah.<?php echo e(pathinfo($dataUser->lampiran_ijazah,PATHINFO_EXTENSION)); ?></h3>
                    ...
                    <form id="scantranskrip" enctype="multipart/form-data">
                        ...
                        <div class="form-group <?php echo e(($dataUser->lampiran_transkripnilai)?"hidden-block":""); ?>">
                          ...
                          <div class="job-listings-featured block-action <?php echo e((!$dataUser->lampiran_transkripnilai)?"hidden-block":"isUploaded"); ?>" id="transkrip-show">
                            <div class="row">
                              <div class="col-lg-5 col-md-5 col-xs-12">
                                <div class="job-details ml-5 mt-4">
                                  <h3 class="title">ScanTranskrip.<?php echo e(pathinfo($dataUser->lampiran_transkripnilai,PATHINFO_EXTENSION)); ?></h3>
                    ...
                    <form id="scanreferensi" enctype="multipart/form-data">
                          <div class="form-group <?php echo e(($dataUser->lampiran_referensikerja)?"hidden-block":""); ?>">
                            ...
                            <div class="job-listings-featured block-action <?php echo e((!$dataUser->lampiran_referensikerja)?"hidden-block":"isUploaded"); ?>" id="referensikerja-show">
                              <div class="row">
                                <div class="col-lg-5 col-md-5 col-xs-12">
                                  <div class="job-details ml-5 mt-4">
                                    <h3 class="title">ScanReferensi.<?php echo e(pathinfo($dataUser->lampiran_referensikerja,PATHINFO_EXTENSION)); ?></h3>
        ...
        <?php /**PATH C:\xampp\htdocs\recruitment\resources\views/jobseeker/datadiri/lampiran.blade.php ENDPATH**/ ?>