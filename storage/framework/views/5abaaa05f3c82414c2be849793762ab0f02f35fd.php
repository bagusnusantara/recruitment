...
<div class="form-group row"><label class="col-sm-3 control-label">Tanggal Mulai Pelatihan</label>
    <div class="col-sm-9">
        <div class="input-group">
            <input type="text" class="form-control date input-sm" name="sdate" id="sdate" value="<?php echo e(\Carbon\Carbon::now()->toDateString()); ?>">
...
<div class="form-group row"><label class="col-sm-3 control-label">Tanggal Akhir Pelatihan</label>
    <div class="col-sm-9">
        <div class="input-group">
            <input type="text" class="form-control date input-sm" name="edate" id="edate" value="<?php echo e(\Carbon\Carbon::now()->toDateString()); ?>">
            <span class="input-group-addon">
                <i class="glyphicon glyphicon-calendar"></i>
            </span>
        </div>
...
</div><?php /**PATH C:\xampp\htdocs\recruitment\resources\views/pegawai/training/form.blade.php ENDPATH**/ ?>