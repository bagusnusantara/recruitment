...
<div class="form-group"><label class="col-sm-4 control-label">Kode</label>
    <div class="col-sm-8"><input type="text" maxlength="5" class="form-control" name="kode" id="kode"></div>
</div>
...
<?php /**PATH C:\xampp\htdocs\recruitment\resources\views/hrd/setup/harilembur/form.blade.php ENDPATH**/ ?>