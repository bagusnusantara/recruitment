<div id="keluarga"  class="tab-content my-resume">
          ...
          <!--keluarga-->
            ...
            <form id="statusperkawinan">
              ...
              <select class="custom-select my-1 mr-sm-2" id="StatusKeluarga">
                  <option <?php echo e((!isset($dataUser->status_keluarga) || $dataUser->status_keluarga == "0" )? "selected" : ""); ?> value="0">Pilih . . .</option>
                  <option <?php echo e(($dataUser->status_keluarga=='Lajang')? "selected" : ""); ?> value="1">Lajang</option>
                  <option <?php echo e(($dataUser->status_keluarga=='Menikah')? "selected" : ""); ?> value="2">Menikah</option>
                  <option <?php echo e(($dataUser->status_keluarga=='Sudah Bercerai')? "selected" : ""); ?> value="3">Sudah Bercerai</option>
              </select>
            </div>
            <div class="form-group">
                <h4><label class="my-1 mr-2" for="TanggalKeluarga">Sejak</label></h4>
                <input type="date" class="form-control" id="TanggalKeluarga" placeholder="Sejak Tahun" <?php echo e((!isset($dataUser->tanggal_keluarga) || $dataUser->tanggal_keluarga == "" )? "disabled" : ""); ?>  value="<?php echo e($dataUser->tanggal_keluarga); ?>">
            </div>
        </form>
          <!--keluarga end-->
                </div>
    ...
    <?php /**PATH C:\xampp\htdocs\recruitment\resources\views/jobseeker/datadiri/keluarga.blade.php ENDPATH**/ ?>